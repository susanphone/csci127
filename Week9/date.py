class Date:
    ...
    # classes are represented with a capital letter.

    def __init__(self, month, day, year):
        """A constructor method that sets the month, day, and year"""
        # self is named after the class itself
        self.month = month
        self.day = day
        self.year = year
...
# Create an instance of Date with the value March 11, 2020
today = Date("March", 11, 2020)
